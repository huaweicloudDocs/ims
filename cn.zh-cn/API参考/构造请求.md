...
<td class="cellrowborder" valign="top" width="26.5%" headers="mcps1.2.5.1.2 "><p id="p1486815116337"><a name="p1486815116337"></a><a name="p1486815116337"></a>消息体的类型（格式）。推荐用户使用默认值application/json，有其他取值时会在具体接口中专门说明。</p>
</td>
...
<td class="cellrowborder" valign="top" width="26.5%" headers="mcps1.2.5.1.2 "><p id="p178681813332"><a name="p178681813332"></a><a name="p178681813332"></a>请求body长度，单位为Byte。</p>
</td>
...
<p id="p15868417337"><a name="p15868417337"></a><a name="p15868417337"></a>请求响应成功后在响应消息头（Headers）中包含的“X-Subject-Token”的值即为Token值。</p>
</td>
