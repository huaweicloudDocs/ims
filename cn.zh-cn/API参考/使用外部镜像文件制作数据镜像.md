...
-   请求参数
    ...
    <td class="cellrowborder" valign="top" width="46.61%" headers="mcps1.1.5.1.4 "><p id="p187601353103514"><a name="p187601353103514"></a><a name="p187601353103514"></a>创建加密镜像的用户主密钥，具体取值请参考“<a href="https://support.huaweicloud.com/usermanual-dew/zh-cn_topic_0034330264.html" target="_blank" rel="noopener noreferrer">查看密钥</a>”获取。</p>
    </td>
    </tr>
