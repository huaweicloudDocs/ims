...
-   响应参数
    ...
    <td class="cellrowborder" valign="top" width="49.63%" headers="mcps1.1.4.1.3 "><p id="p8706203910588"><a name="p8706203910588"></a><a name="p8706203910588"></a>表示当前镜像支持CloudInit密码/密钥注入方式，建议设置为"true"或者"false"。</p>
