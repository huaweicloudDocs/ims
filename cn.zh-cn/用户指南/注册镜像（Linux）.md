# 注册镜像（Linux）<a name="ims_01_0211"></a>
...
2.  创建系统盘镜像。
    ...
    2.  根据界面要求填写如下信息：
        ...
        **表 1**  镜像类型和来源
        ...
        <td class="cellrowborder" valign="top" width="74.03999999999999%" headers="mcps1.2.3.1.2 "><p id="ims_01_0206_p1139533015529"><a name="ims_01_0206_p1139533015529"></a><a name="ims_01_0206_p1139533015529"></a>可选参数，仅在选择zvhd2或raw格式的镜像文件时出现。</p>
