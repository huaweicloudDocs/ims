...
-   为了确保镜像创建的新云服务器同时支持XEN虚拟化和KVM虚拟化，请优化Linux云服务器，包括修改“grub”、“fstab”文件的磁盘标识方式为UUID、安装原生的XEN和KVM驱动等操作。
    ...
    详细操作请参考[优化过程（Linux）](优化过程（Linux）.md)中的步骤[2](优化过程（Linux）.md#zh-cn_topic_0036684058_li52904758173244)\~步骤[6](优化过程（Linux）.md#zh-cn_topic_0036684058_li36218236173244)。
