...
## 安装步骤<a name="section62254326101255"></a>
...
-   **CentOS操作系统**
    ...
    **表 1**  Cloud-Init网络安装地址
    ...
    <td class="cellrowborder" valign="top" width="68.41000000000001%" headers="mcps1.2.4.1.3 "><p id="p2059312384284"><a name="p2059312384284"></a><a name="p2059312384284"></a><a href="https://dl.fedoraproject.org/pub/epel/6/i386/" target="_blank" rel="noopener noreferrer">https://dl.fedoraproject.org/pub/epel/6/i386/</a></p>
    </td>
    </tr>
