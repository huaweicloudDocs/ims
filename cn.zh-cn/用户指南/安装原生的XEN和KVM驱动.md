# 安装原生的XEN和KVM驱动<a name="ims_01_0361"></a>
...
-   请先确认您当前的云服务器为XEN构架，操作步骤详见[判断云服务器虚拟化类型并确认是否需要优化](https://support.huaweicloud.com/usermanual-ims/ims_01_0322.html)。
...
-   SUSE和openSUSE系列系统，根据操作系统版本不同，修改不同的配置文件。
    ...
    操作方法可参[SUSE/openSUSE系列操作系统相关操作](#zh-cn_topic_0086020894_section63790002112835)。
